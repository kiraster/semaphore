export default {
  ...
  openTwoStepVerificationApp: 'Open the two-step verification app on your mobile device to get your verification code.',
  checkEmailForVerificationCode: 'Check your email for the verification code we just sent you.',
  returnToLogin: 'Return to login',
  useRecoveryCode: 'Use recovery code',
  accountRecovery: 'Account recovery',
  useRecoveryCodeToRegainAccess: 'Use your recovery code to regain access to your account.',
  recoveryCode: 'Recovery code',
  recoveryCode_required: 'Recovery code is required',
