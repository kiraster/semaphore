export default {
  ...
  askDeleteInv: '您真的想删除此Inventory吗？',
  ...
  newInventory: '新Inventory',
  name: '名称',
  userCredentials: '用户凭据',
  sudoCredentialsOptional: 'Sudo 凭据（可选）',
  type: '类型',
  pathToInventoryFile: 'Inventory文件路径',
  enterInventory: '输入Inventory...',
  staticInventoryExample: '静态Inventory示例：',
  staticYamlInventoryExample: '静态 YAML Inventory示例：',
  keyName: '密钥名称',
  loginOptional: '登录（可选）',
  ...
  path_required: 'Inventory文件路径是必需的',
  ...
  playbook_filename_required: 'Playbook文件名是必需的',
  inventory_required: 'Inventory是必需的',
  ...
  softwareName: 'DBS运维任务管理平台',
  softwareVersion: 'v2.18.1-ansible2.16.5-beta.1-kiraster.1',

  // 将所有的playbook相关的翻译中的“剧本”改为“Playbook”，以保持专业术语的一致性和准确性-2026-05-25 14:23:49
  // 将所有的库存相关的翻译中的“库存”改为“Inventory”，以保持专业术语的一致性和准确性-2026-05-25 14:23:52
  // 将部分团队相关的翻译中的“团队”改为“团队管理”，以更清晰地表达功能的范围和目的-2026-05-25 14:23:55

  // 编辑用户表单-相关翻译-2026-05-25 15:05:12 - UserForm.vue
  // settings: '设置',
  security: '安全',
  private: '私有',
  ...
  // 双因素认证翻译 - 2026-07-09 11:42:00
  twoStepVerification: '双因素认证',
  openTwoStepVerificationApp: '请在您的移动设备上打开双因素认证应用获取验证码。',
  checkEmailForVerificationCode: '请检查您的邮箱，获取我们刚刚发送的验证码。',
  returnToLogin: '返回登录',
  useRecoveryCode: '使用恢复码',
  accountRecovery: '账户恢复',
  useRecoveryCodeToRegainAccess: '使用您的恢复码重新访问账户。',
  // recoveryCode: '恢复码',
  recoveryCode_required: '恢复码是必需的',
  returnToVerification: '返回验证',
  emailSending: '邮件发送中...',
  resendCodeToEmail: '重新发送验证码到邮箱',
  verificationEmailSentSuccessfully: '验证邮件发送成功。',
  send: '发送',
};
